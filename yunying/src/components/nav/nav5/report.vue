  ...
  <div class="content">
        ...
        <el-row class="el-rowB">
           <el-col :span="24" class="topB flexRow flexAlignC">
             <div class="grid-content bg-purple-dark">举报管理</div>
           </el-col>
        </el-row>
        <el-row class="el-rowB flexRow flexAlignC">
          ...
          <el-col :span="4" class="flexRow flexAlignC" style="padding:0 10px;height:40px;">
             <el-input placeholder="帖子类型、主题名称、作者" v-model="input1" class="input-with-select">
        ...
        <el-row>
          <el-col :span="24">
           <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="name" label="文库类型" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="name" label="机构名称" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="name" label="机构类型" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="name" label="举报人" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="name" label="举报时间" show-overflow-tooltip>
            </el-table-column>
